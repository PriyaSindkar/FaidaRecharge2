...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private static final int MAX_COLLAPSED_LINES = 30;
    ...
    public void onClick(View view) {
        ...
        mButton.setText(mCollapsed ? "Offer Details..." : "Show Less...");
        if(!mCollapsed) {
            mTv1.setVisibility(VISIBLE);
        } else {
    ...
    public void setText(@Nullable CharSequence text, CharSequence promoCode) {
        mRelayout = true;
        mTv.setText(text);
        mTv1.setText(promoCode);
...
*/
    ...
    private void findViews() {
        ...
        mTv1 = (TextView) findViewById(R.id.promocode_text);
        ...
        mTv1.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                cm.setText(mTv1.getText());
                Toast.makeText(_context, "Promo Code Copied", Toast.LENGTH_SHORT).show();

                RedirectToPortalDialog box = new RedirectToPortalDialog(_context);
                box.show();
            }
        });
    }
